...
from nni.retiarii.hub.pytorch.proxylessnas import ConvBNReLU, InvertedResidual, SeparableConv, make_divisible, reset_parameters
...
class MobileNetV3Space(nn.Module):
    ...
    def load_searched_model(
        ...
        init_kwargs = {}
        init_kwargs.update(
            base_widths=[16, 16, 32, 64, 128, 256, 512, 1024],
            width_multipliers=[0.5, 0.625, 0.75, 1.0, 1.25, 1.5, 2.0],
            expand_ratios=[1, 2, 3, 4, 5, 6],
            dropout_rate=0.2,
            bn_eps=1e-3,
            bn_momentum=0.1
        )
